...
import oi.spring.start.projetoweb.service.EditoraService;
...
public class EditoraController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> editar(@RequestBody @Valid EditoraDTO editoraDTO, @PathVariable("id") Integer id){
        try {
